...
const Confirmation = ({ prevStep, nextStep, values, createAndDownloadPdf, name,checkValues }) => {

console.log(checkValues)
  const { firstName, lastName,contact,Hid, date, email,address,Booking,postcode,Yob,Booking2,Gender,comments,Scans,BloodTests,NerveTests,X_rays,pain_start,
    describe_pain, majorillnesses, presentillnesses,mentalservices,injections,Psychology, Physiotherapy, tens, Acupuncture, Chiropractor,othertreatments,detailtreatments,
     smoke, alcohol,physicalactivity,typicalday,often_pain,no_pain,Timeofpainbest,Timeofpainworst,increasepain,decreasepain,relievepain,Trouble_sleep,Medication_Sleep,Awake_pain,
   check_1,Medication_M1,Medication_D1,Medication_F1,Medication_M2,Medication_D2,Medication_F2,Medication_M3,Medication_D3,Medication_F3,Alone,Martual_status,Number_children,
    Number_children_home,Current_situtaion,job_title,state_benfits,legal_actions,
  understand_pain,Management_service,goals,other_comments} = values
    ...
    <Container  component="main" maxWidth="xxx"direction="rows">
      ...
      <div>
        <List>
          ...
          <ListItem>
            <ListItemText primary="Any Comments You wish to make" secondary={comments}/>
                    ...
                    <ListItem>
                      <ListItemText primary="How often do you have pain?" secondary={often_pain}/>
                    </ListItem>
                    <ListItem>
                      <ListItemText primary="Are there times during which you experience no pain?" secondary={no_pain}/>
                    </ListItem>
                    <ListItem>
                      <ListItemText primary="Time of day pain is best" secondary={Timeofpainbest}/>
                    </ListItem>
                    <ListItem>
                      <ListItemText primary="Time of day pain is worst" secondary={Timeofpainworst}/>
                    </ListItem>
                    <ListItem>
                      <ListItemText primary="What causes an increase in your pain?" secondary={increasepain}/>
                    </ListItem>
                    <ListItem>
                      <ListItemText primary="What causes an decrease in your pain?" secondary={decreasepain}/>
                    </ListItem>
                    <ListItem>
                      <ListItemText primary="What can you do to help relieve the pain?" secondary={relievepain}/>
                    </ListItem>
                    <ListItem>
                      <ListItemText primary="Does pain affect your sleep?" />
                      </ListItem>
                      <ListItem>
                        <ListItemText primary="Trouble falling asleep" secondary={Trouble_sleep}/>
                          <ListItemText primary="Medication needed to fall asleep" secondary={Medication_Sleep}/>
                            <ListItemText primary="Awakened by pain" secondary={Awake_pain}/>
                                ...
                                <ListItem>
                                  <ListItemText primary="Please give the details of any major illnesses including the dates if possible"
                                    secondary={majorillnesses} />
                                 </ListItem>
                                 <ListItem>
                                   <ListItemText primary="Please give the details of any other present illnesses"
                                     secondary={presentillnesses} />
                                  </ListItem>
                                  <ListItem>
                                    <ListItemText primary="Have you ever received any help from mental health services?"
                                           ...
                                           <ListItemText primary="tens" secondary={tens}/>
                                             <ListItemText primary="Acupuncture" secondary={Acupuncture}/>
                                               <ListItemText primary="Chiropractor" secondary={Chiropractor}/>
                                                 <ListItemText primary="othertreatments" secondary={othertreatments}/>
                                   </ListItem>
                                   <ListItem>
                                     <ListItemText primary="Details of treatment including dates if possible" secondary={detailtreatments}/>
                                   </ListItem>
                                   <ListItem>
                                     <ListItemText primary="Do you smoke" secondary={smoke}/>
                                   </ListItem>
                                   <ListItem>
                                     <ListItemText primary="Do you drink alcohol" secondary={alcohol}/>
                                   </ListItem>
                                   <ListItem>
                                     <ListItemText primary="What does your pain stop you from doing (physical activity)" secondary={physicalactivity}/>
                                   </ListItem>
                                   <ListItem>
                                     <ListItemText primary="Please give detail of how you spend your typical day" secondary={typicalday}/>
                                   </ListItem>
                                   <ListItem>
                                     <ListItemText primary="Medication 1 - Name" secondary={Medication_M1}/>
                                   </ListItem>
                                   <ListItem>
                                     <ListItemText primary="Medication 1 - Dose" secondary={Medication_D1}/>
                                   </ListItem>
                                   <ListItem>
                                     <ListItemText primary="Medication 1 - Frequency" secondary={Medication_F1}/>
                                   </ListItem>
                                   <ListItem>
                                     <ListItemText primary="Medication 2 - Name" secondary={Medication_M2}/>
                                   </ListItem>
                                   <ListItem>
                                     <ListItemText primary="Medication 2 - Dose" secondary={Medication_D2}/>
                                   </ListItem>
                          <ListItem>
                             <ListItemText primary="Medication 2 - Frequency" secondary={Medication_F2}/>
                             </ListItem>
                          <ListItem>
                               <ListItemText primary="Medication 3 - Name" secondary={Medication_M3}/>
                          </ListItem>
                          <ListItem>
                             <ListItemText primary="Medication 3 - Dose" secondary={Medication_D3}/>
                          </ListItem>
                          <ListItem>
                             <ListItemText primary="Medication 3 - Frequency" secondary={Medication_F3}/>
                          </ListItem>
                       <ListItem>
                           <ListItemText primary="Do you live alone" secondary={Alone}/>
                       </ListItem>
                       <ListItem>
                             <ListItemText primary="Marital status" secondary={Martual_status}/>
                       </ListItem>
                       <ListItem>
                           <ListItemText primary="Number of children" secondary={Number_children}/>
                       </ListItem>
                       <ListItem>
                          <ListItemText primary="Number of children at home" secondary={Number_children_home}/>
                     </ListItem>
                       <ListItem>
                         <ListItemText primary="Current situation" secondary={Current_situtaion}/>
                       </ListItem>
                       <ListItem>
                         <ListItemText primary="When did you stop working?" secondary={job_title}/>
                       </ListItem>
                       <ListItem>
                      ...
                      <ListItem>
                            <ListItemText primary="Are there any legal actions being taken with regard to your pain?" secondary={legal_actions}/>
                      </ListItem>
                      <ListItem>
                            <ListItemText primary="What do you understand to be the cause of your pain?" secondary={understand_pain}/>

                      </ListItem>
                      <ListItem>
                            <ListItemText primary="What would you like to get from attending the Pain Management Service?" secondary={Management_service}/>

                      </ListItem>
                      <ListItem>
                            <ListItemText primary="What are your personal expectations and goals?" secondary={goals}/>

                      </ListItem>
                      <ListItem>
                            <ListItemText primary="Do you have any other comments?" secondary={other_comments}/>
